mergeInto(LibraryManager.library, {
      ...
      firebase
        ...
        .then(function (unused) {
          MyGameInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: " + parsedValue + " was posted to " + parsedPath
          );
        });
    } catch (error) {
      MyGameInstance.SendMessage(
      ...
      firebase
        ...
        .then(function (unused) {
          MyGameInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: " + parsedValue + " was pushed to " + parsedPath
          );
        });
    } catch (error) {
      MyGameInstance.SendMessage(
  ...
  UpdateJSON: function (path, value, objectName, callback, fallback) {
    ...
    try {
      firebase
        .database()
        .ref(parsedPath)
        .update(JSON.parse(parsedValue))
        .then(function (unused) {
          MyGameInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: " + parsedValue + " was updated in " + parsedPath
          );
        });
    } catch (error) {
      MyGameInstance.SendMessage(
      ...
      firebase
        ...
        .then(function (unused) {
          MyGameInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: " + parsedPath + " was deleted"
          );
        });
    } catch (error) {
      MyGameInstance.SendMessage(
  ...
  StopListeningForValueChanged: function (
    path,
    objectName,
    callback,
    fallback
  ...
  StopListeningForChildChanged: function (
    path,
    objectName,
    callback,
    fallback
  ...
  StopListeningForChildRemoved: function (
    path,
    objectName,
    callback,
    fallback
  ...
  ModifyNumberWithTransaction: function (
    path,
    amount,
    objectName,
    callback,
      ...
      firebase
        ...
        .then(function (unused) {
          MyGameInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: transaction run in " + parsedPath
          );
        });
    } catch (error) {
      MyGameInstance.SendMessage(
  ...
  ToggleBooleanWithTransaction: function (
    path,
    objectName,
    callback,
    fallback
